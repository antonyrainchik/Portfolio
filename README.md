...
1: Equitable use
I designed the interface to be useful for people with diverse abilities when I provided clear labeling for all input fields, making it easier for screen readers to understand and relay information to the user.
2: Simple and Intuitive
The simple grid interface for the chat system is straightforward, and avoids unneccesary complexity.

1: Perceptive information
I don't support images or audio at the moment, therefore it can't be percieved by people with reading disabilities.
2: Tolerance for error
I don't do a lot of error checking, and I don't have any checks for if anyone has an action by accident, everything is immediate. 
...
![Depiction of potential compatibility changes](_figures/IMG_49C0EA357B08-1.jpeg)
### Done! 🥳
